...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/hiroBzinga/bun/driver/pgdriver)](https://pkg.go.dev/github.com/hiroBzinga/bun/driver/pgdriver)
...
```shell
go get github.com/hiroBzinga/bun/driver/pgdriver
```

And then create a `sql.DB` using it:

```go
import _ "github.com/hiroBzinga/bun/driver/pgdriver"
